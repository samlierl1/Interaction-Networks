...
One hundred sentences, each from a different book were randomly sampled from the CONLIT_NLP dataset. I then annotated each interaction between a character. In total there were 103 unique pairings found between characters. 
